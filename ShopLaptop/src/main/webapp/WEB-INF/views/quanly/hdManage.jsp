 ...
 <!-- Css Styles -->
    ...
    <body>
         ...
         <div class="container-fluid px-4">
                        <h4 class="mt-4">Quản lý: ${pageContext.request.userPrincipal.name}</h4>
                        <ol class="breadcrumb mb-4">
                   		...
                   		${messHD}			
                   		<div class="row">
      <form action="order-manage-thong-ke-check.htm">
			  <div class="row">
			    <div class="col">
			      <input type="text" class="form-control"  maxlength="10" name = "dateStart" placeholder="yyyy-mm-dd" required>
			    </div>
			    <div class="col">
			      <input type="text" class="form-control" maxlength="10" name = "dateEnd" placeholder="yyyy-mm-dd" required>
			    </div>
			  </div>
			  </br>
